...
cl /nologo -c /D _CRT_SECURE_NO_DEPRECATE /D VST_FORCE_DEPRECATED=0 /D DEMO /D GUI /D _WIN32_WINNT=0x0400 /I ".\include\msinttypes" /I ".\VST2_SDK" /O2 src\*.cpp timidity\*.c VST2_SDK\public.sdk\source\vst2.x\*.cpp
rc res\Timidity.rc
